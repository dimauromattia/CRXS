...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_xs_tools')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_xs_tools')
    _xs_tools = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_xs_tools', [dirname(__file__)])
        except ImportError:
            import _xs_tools
            return _xs_tools
        try:
            _mod = imp.load_module('_xs_tools', fp, pathname, description)
        finally:
            if fp is not None:
                fp.close()
        return _mod
