...
if _swig_python_version_info >= (2, 7, 0):
    def swig_import_helper():
        ...
        mname = '.'.join((pkg, '_xs_wrapper')).lstrip('.')
        try:
            return importlib.import_module(mname)
        except ImportError:
            return importlib.import_module('_xs_wrapper')
    _xs_wrapper = swig_import_helper()
    ...
    def swig_import_helper():
        ...
        fp = None
        try:
            fp, pathname, description = imp.find_module('_xs_wrapper', [dirname(__file__)])
        except ImportError:
            import _xs_wrapper
            return _xs_wrapper
        try:
            _mod = imp.load_module('_xs_wrapper', fp, pathname, description)
        finally:
            if fp is not None:
                fp.close()
        return _mod
...
def inv_AA_Dbar_LAB(Tn_proj_LAB, Tn_Dbar_LAB, eta_LAB, A_projectile, N_projectile, A_target, N_target, parametrization, coalescence):
...
def dEn_DbarA_Dbar_LAB(Tn_proj_LAB, Tn_Dbar_LAB, A_target, N_target, parametrization):
    return _xs_wrapper.dEn_DbarA_Dbar_LAB(Tn_proj_LAB, Tn_Dbar_LAB, A_target, N_target, parametrization)
dEn_DbarA_Dbar_LAB = _xs_wrapper.dEn_DbarA_Dbar_LAB
