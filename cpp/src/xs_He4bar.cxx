...
//  }
  ...
  double XS::inv_AA_He4bar_CM( double s, double xF_hebar, double pT_hebar, int A_projectile, int N_projectile, int A_target, int N_target, int parametrization, int coalescence){
    ...
    double factortwist_1 = inv_pp_pbar * inv_pp_pbar_red * inv_pp_nbar_red_red * inv_pp_nbar_red_red_red + inv_pp_pbar * inv_pp_pbar_red * inv_pp_nbar_red_red * inv_pp_nbar_red_red_red + inv_pp_pbar * inv_pp_nbar_red * inv_pp_pbar_red_red  * inv_pp_nbar_red_red_red + inv_pp_pbar * inv_pp_nbar_red * inv_pp_nbar_red_red * inv_pp_pbar_red_red_red;
    double factortwist_2 = inv_pp_pbar * inv_pp_pbar_red * inv_pp_nbar_red_red * inv_pp_nbar_red_red_red + inv_pp_pbar * inv_pp_pbar_red * inv_pp_nbar_red_red * inv_pp_nbar_red_red_red + inv_pp_pbar * inv_pp_nbar_red * inv_pp_pbar_red_red  * inv_pp_nbar_red_red_red + inv_pp_pbar * inv_pp_nbar_red * inv_pp_nbar_red_red * inv_pp_pbar_red_red_red;
    double factortwist_3 = inv_pp_nbar * inv_pp_nbar_red * inv_pp_pbar_red_red * inv_pp_pbar_red_red_red + inv_pp_nbar * inv_pp_nbar_red * inv_pp_pbar_red_red * inv_pp_pbar_red_red_red + inv_pp_nbar * inv_pp_pbar_red * inv_pp_nbar_red_red  * inv_pp_pbar_red_red_red + inv_pp_nbar * inv_pp_pbar_red * inv_pp_pbar_red_red * inv_pp_nbar_red_red_red;
    double factortwist_4 = inv_pp_nbar * inv_pp_nbar_red * inv_pp_pbar_red_red * inv_pp_pbar_red_red_red + inv_pp_nbar * inv_pp_nbar_red * inv_pp_pbar_red_red * inv_pp_pbar_red_red_red + inv_pp_nbar * inv_pp_pbar_red * inv_pp_nbar_red_red  * inv_pp_pbar_red_red_red + inv_pp_nbar * inv_pp_pbar_red * inv_pp_pbar_red_red * inv_pp_nbar_red_red_red;
    XS *= (1./(nucleons)) * AA * AA_red * AA_red_red * AA_red_red_red * ( factortwist_1 + factortwist_2 + factortwist_3 + factortwist_4 );
